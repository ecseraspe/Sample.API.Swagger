# Sample.API.Swagger OpenAPI Specification
[![Build Status](https://travis-ci.org/ecseraspe/Sample.API.Swagger.svg?branch=master)](https://travis-ci.org/ecseraspe/Sample.API.Swagger)
...
6. If you did everything correct, https://ecseraspe.github.io/Sample.API.Swagger/ will lead to your new docs
...
- Documentation(ReDoc): https://ecseraspe.github.io/Sample.API.Swagger/
- SwaggerUI: https://ecseraspe.github.io/Sample.API.Swagger/swagger-ui/
- Look full spec:
    + JSON https://ecseraspe.github.io/Sample.API.Swagger/swagger.json
    + YAML https://ecseraspe.github.io/Sample.API.Swagger/swagger.yaml
- Preview spec version for branch `[branch]`: https://ecseraspe.github.io/Sample.API.Swagger/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ecseraspe.github.io/Sample.API.Swagger/ with url from the message: `Server started <url>`
